Ext.define('Ext.ux.chart.series.KPIGauge', {
	...
	drawSeries: function () {
        ...
        value = me.value;
        // update by : Irfan Maulana for temporary value
        tempValue = value;
        // update by : Irfan Maulana for set to maximum value when value > maximum value
        if(value > maximum){
        	value = maximum;
        }
        // update by : Irfan Maulana 
        // added getCustomNumber
		// please include this function ==> function.js
        tempValue = getCustomNumber(tempValue);
